...
module.exports = function TypedArraySetElement(O, index, value) {
	...
	if (IsValidIntegerIndex(O, index)) { 
		...
		var byteIndexInBuffer = (index * elementSize) + offset; 

		var elementType = TypedArrayElementType(O); 

		SetValueInBuffer(typedArrayBuffer(O), byteIndexInBuffer, elementType, numValue, true, 'UNORDERED'); 
	}
};
