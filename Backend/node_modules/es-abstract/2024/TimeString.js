...
module.exports = function TimeString(tv) {
	...
	var hour = ToZeroPaddedDecimalString(HourFromTime(tv), 2); 

	var minute = ToZeroPaddedDecimalString(MinFromTime(tv), 2); 

	var second = ToZeroPaddedDecimalString(SecFromTime(tv), 2); 
