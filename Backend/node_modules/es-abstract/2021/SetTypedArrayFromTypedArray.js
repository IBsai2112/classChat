...
module.exports = function SetTypedArrayFromTypedArray(target, targetOffset, source) {
	...
	var targetName = whichTarget; 

	var targetType = tableTAO.name['$' + targetName]; 

	var targetElementSize = tableTAO.size['$' + targetType]; 

	var targetByteOffset = typedArrayByteOffset(target); 

	var srcName = whichSource; 

	var srcType = tableTAO.name['$' + srcName]; 

	var srcElementSize = tableTAO.size['$' + srcType]; 
