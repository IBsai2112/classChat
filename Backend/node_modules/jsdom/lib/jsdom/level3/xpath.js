...
module.exports = core => {
  ...
  var axes = xpath.axes = {
    'ancestor':
      function ancestor(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        return ancestorHelper(
          nodeList  , nodeTypeNum, nodeName, shouldLowerCase, false);
      },
    'ancestor-or-self':
      function ancestorOrSelf(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        return ancestorHelper(
          nodeList  , nodeTypeNum, nodeName, shouldLowerCase, true);
      },
    'attribute':
      function attribute(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
    ...
    'child':
      function child(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        var matcher = new NodeMatcher(nodeTypeNum, nodeName, shouldLowerCase);
        var nodeMultiSet = new NodeMultiSet(false);
        for (var i = 0; i < nodeList.length; ++i) {
          var n = nodeList[i];
    ...
    'descendant':
      function descenant(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        return descenantHelper(
          nodeList  , nodeTypeNum, nodeName, shouldLowerCase, false);
      },
    'descendant-or-self':
      function descenantOrSelf(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        return descenantHelper(
          nodeList  , nodeTypeNum, nodeName, shouldLowerCase, true);
      },
    'following':
      function following(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        return followingHelper(nodeList  , nodeTypeNum, nodeName, shouldLowerCase);
      },
    'following-sibling':
      function followingSibling(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        return followingSiblingHelper(
          nodeList  , nodeTypeNum, nodeName, shouldLowerCase,
          Array.prototype.shift, function() {return this[0];},
          function(node) {return node.nextSibling;});
      },
    'namespace':
      function namespace(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        
      },
    'parent':
      function parent(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        var matcher = new NodeMatcher(nodeTypeNum, nodeName, shouldLowerCase);
        var nodes = [], pos = [];
        for (var i = 0; i < nodeList.length; ++i) {
    ...
    'preceding':
      function preceding(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        return precedingHelper(
          nodeList  , nodeTypeNum, nodeName, shouldLowerCase);
      },
    'preceding-sibling':
      function precedingSibling(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        return followingSiblingHelper(
          nodeList  , nodeTypeNum, nodeName, shouldLowerCase,
    ...
    'self':
      function self(nodeList  , nodeTypeNum, nodeName, shouldLowerCase) {
        var nodes = [], pos = [];
        var matcher = new NodeMatcher(nodeTypeNum, nodeName, shouldLowerCase);
        for (var i = 0; i < nodeList.length; ++i) {
